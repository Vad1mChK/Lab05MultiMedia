...
class VideoDownloader(QMainWindow):
    ...
    def on_download_error(self, err):
        ...
        self.update_video_name_label(f'Download error: {err}')
        self.toggle_download_if_ready()
    ...
    def on_download(self):
        ...
        self.worker.video_name_change.connect(lambda video_name: self.update_video_name_label(video_name, is_video_name=True))
        self.worker.start()
